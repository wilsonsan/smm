  ...
  return (
    <section className="section-stack">
      <header className="page-header">
        <div>
          <h2>Instagram</h2>
          <p>View the Instagram professional account discovered through the connected Facebook Page.</p>
        </div>
      ...
      <section className="panel settings-section-card">
        <div className="settings-section-head">
          <div>
            ...
            <p>The Facebook business connection authorizes both the Page and its linked Instagram professional account.</p>
          </div>
        ...
        <section className="settings-subcard">
          ...
          <div className="form-grid">
            ...
            <p className="hint">Instagram content publishing is enabled. Comment management and first-comment publishing are not enabled.</p>
            {!isReady ? (
